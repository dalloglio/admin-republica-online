<template>
  <div v-if="form.id" class="resumes index">
    ...
    <el-table :data="contacts" empty-text="Não há registros..." :default-sort="{ prop: 'name', order: 'ascending' }" border stripe fit>
      ...
      <el-table-column prop="role" label="Cargo" sortable></el-table-column>
      ...
      <el-table-column
        ...
        <template scope="scope">
          <el-button-group>
            <el-button type="warning" size="small" @click="url.go({ name: 'resumes.show', params: { id: scope.row.id } })">Ver</el-button>
